...
namespace cMenu.Metaobjects.Extended.Order
{
    ...
    public class CMenuServiceOrder
    {
        ...
        public int OrderGetByKey(IDatabaseProvider Provider)
        {
            ...
            this._sessionKey = T.Rows[0][2].PostProcessValue<decimal>(CDBConst.CONST_OBJECT_EMPTY_KEY);
            this._date = T.Rows[0][3].PostProcessValue<DateTime>(DateTime.Now);
            this._deadline = T.Rows[0][4].PostProcessValue<DateTime>(DateTime.Now);
        ...
        public static List<CMenuServiceOrder> sGetAllOrders(IDatabaseProvider Provider)
        {
            ...
            for (int i = 0; i < T.Rows.Count; i++)
            {
                ...
                Order.Key = T.Rows[i][0].PostProcessValue<decimal>();
                Order.ID = Guid.Parse(T.Rows[i][1].PostProcessValue<string>());
                Order.SessionKey = T.Rows[i][2].PostProcessValue<decimal>();
                Order.Date = T.Rows[i][3].PostProcessValue<DateTime>();
                Order.Deadline = T.Rows[i][4].PostProcessValue<DateTime>();
                R.Add(Order);
            }
