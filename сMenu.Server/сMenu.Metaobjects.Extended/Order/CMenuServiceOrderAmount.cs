...
namespace cMenu.Metaobjects.Extended.Order
{
    ...
    public class CMenuServiceOrderAmount
    {
        ...
        protected decimal _orderKey = -1;
        protected decimal _amountKey = -1;
        ...
        public static List<CMenuServiceOrderAmount> sGetAmountsByOrder(decimal Key, IDatabaseProvider Provider)
        {
            ...
            for (int i = 0; i < T.Rows.Count; i++)
            {
                ...
                Amount.OrderKey = T.Rows[i][0].CheckDBNULLValue<decimal>();
                Amount.AmountKey = T.Rows[i][1].CheckDBNULLValue<decimal>();
                Amount.Amount = T.Rows[i][2].CheckDBNULLValue<int>();
