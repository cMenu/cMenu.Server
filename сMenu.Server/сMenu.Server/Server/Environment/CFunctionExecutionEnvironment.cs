...
namespace cMenu.Communication.Server.Environment
{
    public class CFunctionExecutionEnvironment
    {
        ...
        public static IDatabaseProvider sGetCurrentProvider()
        {
            ...
            {
                case EnServerDB.EMsSQL: _provider = new CMSSQLProvider() { Configuration = _appSrvrConfiguration.ConnectionString }; break;
                case EnServerDB.EMySQL: _provider = new CMySQLProvider() { Configuration = _appSrvrConfiguration.ConnectionString }; break;
                case EnServerDB.EOralce: _provider = new COracleProvider() { Configuration = _appSrvrConfiguration.ConnectionString }; break;
                case EnServerDB.ESQLLite: _provider = new CSQLLiteProvider() { Configuration = _appSrvrConfiguration.ConnectionString }; break;
            }
