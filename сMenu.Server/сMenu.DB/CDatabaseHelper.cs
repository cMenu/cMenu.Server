...
namespace cMenu.DB
{
    public static class CDatabaseHelperExt
    {
        ...
        public static T PostProcessValue<T>(this object Value, object DefaultValue = null)
        {
            return CDatabaseHelper.sPostProcessValue<T>(Value, DefaultValue);
        }
        #endregion
    }
    ...
    {
        #region STATIC FUNCTIONS
        public static T sPostProcessValue<T>(object Value, object DefaultValue = null)
        {
