...
namespace cMenu.DB
{
    ...
    {
        public const decimal CONST_OBJECT_EMPTY_KEY = -255;

        #region ASSOCIATIONS
        public const string FK_T_META_SEC_T_OBJ = "FK_T_META_SEC_T_OBJ";
        public const string FK_T_OBJ_ATTR_T_OBJ = "FK_T_OBJ_ATTR_T_OBJ";
        public const string FK_T_OBJ_COMMENTS_T_OBJ = "FK_T_OBJ_COMMENTS_T_OBJ";
        public const string FK_T_OBJ_LINKS_T_OBJ1 = "FK_T_OBJ_LINKS_T_OBJ1";
        public const string FK_T_OBJ_LINKS_T_OBJ = "FK_T_OBJ_LINKS_T_OBJ";        
        public const string FK_T_ORDERS_T_SESSION = "FK_T_ORDERS_T_SESSION";
        public const string FK_T_ORDERS_AMOUNTS_T_ORDERS = "FK_T_ORDERS_AMOUNTS_T_ORDERS";
        public const string FK_T_RDS_ATTR_T_OBJ = "FK_T_RDS_ATTR_T_OBJ";
        public const string FK_T_RDS_ELEM_T_OBJ = "FK_T_RDS_ELEM_T_OBJ";
        public const string FK_T_RDS_ELEM_DATA_T_RDS_ELEM = "FK_T_RDS_ELEM_DATA_T_RDS_ELEM";
        public const string FK_T_RDS_ELEM_DATA_T_RDS_ATTR = "FK_T_RDS_ELEM_DATA_T_RDS_ATTR";
        public const string FK_T_RDS_LINKS_T_RDS_ATTR = "FK_T_RDS_LINKS_T_RDS_ATTR";
        public const string FK_T_RDS_LINKS_T_RDS_ATTR1 = "FK_T_RDS_LINKS_T_RDS_ATTR1";
        public const string FK_T_SESSION_T_OBJ = "FK_T_SESSION_T_OBJ";        
        #endregion
        ...
        public const string CONST_TABLE_FIELD_SESSION_DEADLINE = "F_SES_DEADLINE";
        public const string CONST_TABLE_FIELD_SESSION_STATUS = "F_SES_STATUS";
        public const string CONST_TABLE_FIELD_SESSION_VARIABLES = "F_SES_VAR";
        public const string CONST_TABLE_FIELD_SESSION_TYPE = "F_SES_TYPE";
        #endregion
        ...
        public const string CONST_TABLE_FIELD_ORDERS_DEADLINE = "F_ORDER_DEADLINE";
