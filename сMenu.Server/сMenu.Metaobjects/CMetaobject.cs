    ...
    public class CMetaobject
    {
        ...
        public virtual int ObjectGetByKey(IDatabaseProvider Provider)
        {
            ...
            else
            {
                ...
                this._parent = T.Rows[0][2].PostProcessValue<decimal>(-3);
                this._class = T.Rows[0][3].PostProcessValue<EnMetaobjectClass>();
                this._system = ((T.Rows[0][4].PostProcessValue<int>(0)) == 1);
                this._modificationDate = T.Rows[0][5].PostProcessValue<DateTime>(DateTime.Now);
                this._status = T.Rows[0][6].PostProcessValue<EnMetaobjectStatus>(EnMetaobjectStatus.EEnabled);
                this._attributes.ObjectKey = this._key;
            }
        ...
        public List<CMetaobject> GetChildren(IDatabaseProvider Provider, bool Recursive = true)
        {
            ...
            if (T != null)
                for (int i = 0; i < T.Rows.Count; i++)
                {
                    ...
                    Object.Key = T.Rows[i][0].PostProcessValue<decimal>(CDBConst.CONST_OBJECT_EMPTY_KEY);
                    Object.ID = Guid.Parse(T.Rows[i][1].PostProcessValue<string>(""));
                    Object.Parent = T.Rows[i][2].PostProcessValue<decimal>(-3);
                    Object.Class = T.Rows[i][3].PostProcessValue<EnMetaobjectClass>();
                    Object.System = ((T.Rows[i][4].PostProcessValue<int>(0)) == 1);
                    Object.ModificatonDate = T.Rows[i][5].PostProcessValue<DateTime>(DateTime.Now);
                    Object.Status = T.Rows[i][6].PostProcessValue<EnMetaobjectStatus>();
        ...
        public bool Exists(IDatabaseProvider Provider)
        {
            ...
            int R = (T != null ? T.Rows[0][0].PostProcessValue<int>() : 1);
            return (R > 0);
        }
        ...
        public static List<CMetaobject> sGetObjectsByClass(EnMetaobjectClass Class, IDatabaseProvider Provider)
        {
            ...
            for (int i = 0; i < T.Rows.Count; i++)
            {
                ...
                Object.Class = T.Rows[i][3].PostProcessValue<EnMetaobjectClass>();
                Object.System = (T.Rows[i][4].PostProcessValue<int>(0) == 1);
                Object.ModificatonDate = T.Rows[0][5].PostProcessValue<DateTime>(DateTime.Now);
                Object.Status = T.Rows[0][6].PostProcessValue<EnMetaobjectStatus>();
                Object.Attributes.ObjectKey = Object.Key;
                R.Add(Object);
            }
