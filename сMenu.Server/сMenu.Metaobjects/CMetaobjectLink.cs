...
namespace cMenu.Metaobjects
{
    ...
    public class CMetaobjectLink
    {
        ...
        public int LinkGet(IDatabaseProvider Provider)
        {
            ...
            this._sourceObjectKey = T.Rows[0][0].PostProcessValue<decimal>(CDBConst.CONST_OBJECT_EMPTY_KEY);
            this._linkedObjectKey = T.Rows[0][1].PostProcessValue<decimal>(CDBConst.CONST_OBJECT_EMPTY_KEY);
            this._linkValue = T.Rows[0][2].PostProcessValue<int>(-1);
            this._linkType = T.Rows[0][3].PostProcessValue<EnMetaobjectLinkType>();
        ...
        public static List<CMetaobjectLink> sGetExternalLinks(decimal ObjectKey, IDatabaseProvider Provider)
        {
            ...
            for (int i = 0; i < T.Rows.Count; i++)
            {
                ...
                {
                    SourceObjectKey = T.Rows[i][0].PostProcessValue<decimal>(CDBConst.CONST_OBJECT_EMPTY_KEY),
                    LinkedObjectKey = T.Rows[i][1].PostProcessValue<decimal>(CDBConst.CONST_OBJECT_EMPTY_KEY),
                    LinkValue = T.Rows[i][2].PostProcessValue<int>(-1),
                    LinkType = T.Rows[i][3].PostProcessValue<EnMetaobjectLinkType>()
                };
                R.Add(Link);
            }
