...
namespace cMenu.Rds
{
    ...
    public class CRdsAttributeValue
    {
        ...
        public int ValueGet(int LanguageCode, IDatabaseProvider Provider)
        {
            ...
            byte[] Data = T.Rows[0][3].CheckDBNULLValue<byte[]>();
        ...
        public int ValueGetAll(IDatabaseProvider Provider)
        {
            ...
            {
                byte[] Data = T.Rows[i][3].CheckDBNULLValue<byte[]>();
                var R = Data.ToDataStream().DeserializeBinaryStream<object>();
                this._values.Add(T.Rows[i][2].CheckDBNULLValue<int>(), R);
            }
        ...
        public static int sValuesDeleteByAttribute(decimal AttributeKey, IDatabaseProvider Provider)
        {
            Hashtable Params = new Hashtable();
        ...
        public static int sValuesDeleteByElement(decimal ElementVersion, IDatabaseProvider Provider)
        {
            Hashtable Params = new Hashtable();
