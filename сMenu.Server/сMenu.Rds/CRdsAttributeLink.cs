...
namespace cMenu.Rds
{
    public class CRdsAttributeLink : CBaseEntity
    {
        ...
        public int LinkGetByKey(IDatabaseProvider Provider)
        {
            ...
            this._name = T.Rows[0][2].CheckDBNULLValue<string>();
            this._attributeKey = T.Rows[0][3].CheckDBNULLValue<decimal>();
            this._linkedAttributeKey = T.Rows[0][4].CheckDBNULLValue<decimal>();
        ...
        public static List<CRdsAttributeLink> sGetLinksByAttribute(decimal AttributeKey, IDatabaseProvider Provider)
        {
            ...
            for (int i = 0; i < T.Rows.Count; i++)
            {
                ...
                {
                    Key = T.Rows[i][0].CheckDBNULLValue<decimal>(),
                    ID = Guid.Parse(T.Rows[i][1].CheckDBNULLValue<string>()),
                    Name = T.Rows[i][2].CheckDBNULLValue<string>(),
                    AttributeKey = T.Rows[i][3].CheckDBNULLValue<decimal>(),
                    LinkedAttributeKey = T.Rows[i][4].CheckDBNULLValue<decimal>()
                };
                R.Add(Link);
            }
