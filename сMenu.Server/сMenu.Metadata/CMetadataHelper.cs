...
{
    public static class CMetadataHelperExtensions
    {
    ...
    public class CMetadataHelper
    {
        ...
        public static CMetaClassAttribute sGetTypeMetadata(Type T)
        {
            ...
            return new CMetaClassAttribute()
            {
                VisibleForMetadataManager = false
            };
        }
        ...
        public static CMetaPropertyBindingAttribute sGetPropertyMetadata(PropertyInfo Property)
        {
            ...
            return new CMetaPropertyBindingAttribute()
            {
                AllowBinding = false,
                VisibleForMetadataManager = true
            };
        }
