...
namespace cMenu.Security.Linq.UsersManagement
{
    ...
    public class CSystemUserSession
    {
        ...
        protected Dictionary<string, object> _variablesDictionary = new Dictionary<string, object>();
        #endregion        
        ...
        public Dictionary<string, object> VariablesDictionary
        {
            get { return _variablesDictionary; }
            set { _variablesDictionary = value; }
        }
        #endregion  

        #region PROTECTED FUNCTIONS
        public Dictionary<string, object> _getVariablesDictionary()
        {
            return this._variables.ToDataStream().DeserializeBinaryStream<Dictionary<string, object>>();
        }
        public int _setVariablesDictionary(Dictionary<string, object> Value)
        {
            this._variables = this._variablesDictionary.SerializeBinaryStream().ToDataByteArray();
            return -1;
        }
        #endregion

        #region PUBLIC FUNCTIONS
        public int SessionVariablesSave()
        {
            this._setVariablesDictionary(this._variablesDictionary);

            return CErrors.ERR_SUC;
        }
        public int SessionVariablesLoad()
        {
            this._variablesDictionary = this._getVariablesDictionary();
