...
namespace cMenu.Metaobjects.Linq
{
    ...
    public class CMetaobjectAttributeLocalized<T>
    {
        ...
        {
            get { return (T)_attributes[_attributeID][Locale].AttributeValue; }
            set { _attributes[_attributeID][Locale].AttributeValue = value; }
        }
        public T DefaultValue
        {
            get { return (T)_attributes[_attributeID][-1].AttributeValue; }
            set { _attributes[_attributeID][-1].AttributeValue = value; }
        }
        #endregion
    }
}
